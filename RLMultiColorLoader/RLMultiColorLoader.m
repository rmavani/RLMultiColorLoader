...
@implementation RLMultiColorLoader
...
- (void)initialSetup {
    ...
    self.radius = MIN(self.bounds.size.width, self.bounds.size.height)/2 - self.circleLayer.lineWidth / 2.0;
